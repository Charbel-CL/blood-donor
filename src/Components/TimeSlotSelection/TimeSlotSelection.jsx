...
const TimeSlotSelection = () => {
  ...
  const handleConfirmBooking = async () => {
    ...
    // Convert selected time to Lebanon time (Asia/Beirut)
    const lebanonTime = dayjs(selectedDateTime).tz("Asia/Beirut", true);
    ...
    const bookingData = {
      ...
      quantity: 1,
      donation_date: lebanonTime.format(), // Convert to ISO string
    };
